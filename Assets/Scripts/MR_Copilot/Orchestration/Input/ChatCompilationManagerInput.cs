...
// public class ChatCompilationManagerInput : MonoBehaviour
// {
...
//     async void Run_with_Inspector_and_Refiner()  //Cathy: havent yet integrated the refiner with input
//     {
//         // get user request
...
//         }
//         refinedInput.text = "Instruction: " + refinedInput.text;
//         // analyze the scene if desired
//         if (inputManager.chatbot.input != null)
//         {
//             Debug.Log("adding inputmanager input");
//             await inputManager.AnalyzeInput();
//             if (inputManager.useRawJson)
//             {
//                 refinedInput.text = "Input: " + inputManager.handsJsonCompact + '\n' + refinedInput.text;
//             }
//             else {
//             refinedInput.text = "Input: " + inputManager.chatbot.output + '\n' + refinedInput.text;
//             }
...
//                     // provide raw scene parsing and input manager
//                     //string inspector_input = inspector.PrepareInspectorInput(scene_parser.chatbot.output, inputManager.chatbot.output, generated_code);
//                     if (inputManager.useRawJson)
//                     {
//                         string inspector_input = inspector.PrepareInspectorWithInput(scene_parser.chatbot.output, inputManager.handsJsonCompact, generated_code);
//                         // clear the inspector's memory before chatting with it
//                         await inspector.SendNewChatWithInput(inspector_input);
//                     }
//                     else
//                     {
//                         string inspector_input = inspector.PrepareInspectorWithInput(scene_parser.chatbot.output, inputManager.chatbot.output, generated_code);
//                         // clear the inspector's memory before chatting with it
//                         await inspector.SendNewChatWithInput(inspector_input);
//                     }
