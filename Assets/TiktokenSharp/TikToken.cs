...
namespace TiktokenSharp
{
    public class TikToken
    {
        ...
        //public static string PBEFileDirectory { get; set; } = Path.Combine(Application.temporaryCachePath, "bpe");

        //load from resources
        public static string PBEFileDirectory { get; set; } = "GPT_Tokenizer/cl100k_base";
        ...
        public int GetNumTokens(string input_str)
        {
            return Encode(input_str).Count;
        }
